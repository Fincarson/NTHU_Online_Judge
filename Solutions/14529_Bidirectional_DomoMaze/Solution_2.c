...
int DP(int ** original, int initial, int initX, int initY); // For original direction
int DP2(int ** original, int initial, int initX, int initY); // For reverse direction
...
int DP(int ** original, int initial, int initX, int initY){
    ...
    return ans + arr[finalX][finalY];
}

int DP2(int ** original, int initial, int initX, int initY){
    ...
    for(int i=0; i<H; i++){
        for(int j=W-1; j>=0; j--){ // Change this one
            if(i == initX && j == initY){
                arr[i][j] = initial;
            }
            else if(original[i][j] == 1){
    ...
    return ans + arr[finalX][finalY]; // Change
}
